...
actor MBToken {
  ...
  let ledger = Map.new<Principal, Nat>();
   Map.set<Principal, Nat>(ledger, phash, Principal.fromText("nkqop-siaaa-aaaaj-qa3qq-cai"), 50);
  //  Map.set<Principal, Nat>(ledger, phash, Principal.fromText("2vxsx-fae"), 500);
